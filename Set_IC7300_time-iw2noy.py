...
#
print ("")
print ("Sto veramente funzionando su Winzozz, grazie a IW2NOY ! :-)")
print ("Servo per sincronizzare l'orario del PC su quel cesso del IC-7300...")
...
while(count < 11):
    ...
    dati = str(senddata)
    giro = str(count)
    print ("Dati inviati al cesso al giro " + giro  + " : " + dati)
    # Fine aggiunta
